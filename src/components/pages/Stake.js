            ...
            <Col xs={24}>
              ...
              <Row style={{marginBottom: "50px"}}>
                ...
                <Col xs={24} sm={6} style={paneStyle}>
                  ...
                  {!loadingBalances && (balances || []).map((coin, i) => (
                    <Row key={coin.ticker + i} style={coinRowStyle}>
                      <Col xs={24}>
                ...
                <Col 
                  xs={24} 
                  sm={16} 
                  style={{backgroundColor: "#48515D", marginTop: "20px", borderRadius: 5,}}
                >
                  ...
                  <Row>
                    <Col>
                      <Button
                        ...
                        onClick={() => { confirmation(MODE_STAKE) }}
                        loading={sending}
                      >
                        STAKE
                      </Button>
                ...
                <Row>
                  <Col>
                    <Button secondary
                      style={{height:30, width:150, marginTop: 10}}
                      onClick={() => { confirmation(MODE_WITHDRAWL) }}
                      loading={sending}
                    >
                      WITHDRAW
                    </Button>
